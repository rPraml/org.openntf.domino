...
/**
 * XOTS was stripped down to minimum, because it is not yet productive ready. Only {@link Tasklet#session()} is left to clone the correct
 * session; Use a framework like Quartz for scheduling
 * 
...
@Inherited
public @interface DominoTasklet {
	...
	DominoTasklet.Session session() default DominoTasklet.Session.CLONE;
